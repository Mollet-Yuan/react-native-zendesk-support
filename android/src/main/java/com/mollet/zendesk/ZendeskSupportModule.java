...
public class ZendeskSupportModule extends ReactContextBaseJavaModule {
    ...
    public static ArrayList<String> getArrayListOfStrings(ReadableMap options, String key, String functionHint) {
        ...
        if (options.getType(key) != ReadableType.Array) {
            Log.e(ZendeskSupportModule.TAG, "wrong type for key '" + key + "' when processing " + functionHint
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            if (arr.getType(i) != ReadableType.String) {
                Log.e(ZendeskSupportModule.TAG, "wrong type for key '" + key + "[" + i + "]' when processing "
    ...
    public static String getStringOrNull(ReadableMap options, String key, String functionHint) {
        ...
        if (options.getType(key) != ReadableType.String) {
            Log.e(ZendeskSupportModule.TAG,
    ...
    public static PreChatFormFieldStatus getFieldStatusOrDefault(ReadableMap options, String key,
        ...
        if (options.getType(key) != ReadableType.String) {
            Log.e(ZendeskSupportModule.TAG, "wrong type for key '" + key
    ...
    private void loadTags(ReadableMap options) {
        ...
        ArrayList<String> allProvidedTags = ZendeskSupportModule.getArrayListOfStrings(options, "tags", "startChat");
    ...
    public void startChat(ReadableMap options) {
        ...
        ReadableMap flagHash = ZendeskSupportModule.getReadableMap(options, "behaviorFlags", "startChat");
        ...
        String department = ZendeskSupportModule.getStringOrNull(options, "department", "startChat");
        if (department != null) {
